...
import com.monkeysarmy.fit.data.AnimationSpeed;
import com.monkeysarmy.fit.data.ApiEndpoint;
import com.monkeysarmy.fit.data.ApiEndpoints;
import com.monkeysarmy.fit.data.CaptureIntents;
import com.monkeysarmy.fit.data.Injector;
import com.monkeysarmy.fit.data.IsMockMode;
import com.monkeysarmy.fit.data.LumberYard;
import com.monkeysarmy.fit.data.NetworkDelay;
import com.monkeysarmy.fit.data.NetworkFailurePercent;
import com.monkeysarmy.fit.data.NetworkVariancePercent;
import com.monkeysarmy.fit.data.PicassoDebugging;
import com.monkeysarmy.fit.data.PixelGridEnabled;
import com.monkeysarmy.fit.data.PixelRatioEnabled;
import com.monkeysarmy.fit.data.ScalpelEnabled;
import com.monkeysarmy.fit.data.ScalpelWireframeEnabled;
import com.monkeysarmy.fit.data.api.MockGithubService;
import com.monkeysarmy.fit.data.api.MockRepositoriesResponse;
import com.monkeysarmy.fit.data.prefs.InetSocketAddressPreferenceAdapter;
import com.monkeysarmy.fit.ui.debug.ContextualDebugActions.DebugAction;
import com.monkeysarmy.fit.ui.logs.LogsDialog;
import com.monkeysarmy.fit.ui.misc.EnumAdapter;
import com.monkeysarmy.fit.util.Keyboards;
...
public final class DebugView extends FrameLayout {
  ...
  @OnClick(R.id.debug_logs_show) void showLogs() {
    new LogsDialog(new ContextThemeWrapper(getContext(), R.style.Theme_Monkey), lumberYard).show();
  }
