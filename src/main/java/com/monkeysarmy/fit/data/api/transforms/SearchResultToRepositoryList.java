package com.monkeysarmy.fit.data.api.transforms;
...
public final class SearchResultToRepositoryList
    implements Func1<Result<RepositoriesResponse>, List<Repository>> {
